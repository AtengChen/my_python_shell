...
if __name__ == "__main__":
    ...
    if platform.system() == 'Linux' and len(sys.argv) > 1:
        # Trim the list of command-line arguments to include only the first one assuming on linux that will be the name of the python main module
        # e.g. if executed from my_python_shell.sh this would be '.'
        sys.argv = sys.argv[:1]
